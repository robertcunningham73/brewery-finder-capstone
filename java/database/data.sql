INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours, brewery_history, brewer_id, active) VALUES ('Brewery On Main', '923 Main Street', 'Philadelphia', 'PA', '19032', '111-111-1111', 'Breweryonmain@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of Brewery On Main', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Homer''s Brewery', '293 Broad Street', 'Anaheim', 'CA', '78392', '222-222-2222', 'Homersbrewer@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of Homer''s Brewery', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Liberty Brewery', '14 Hay Road', 'Houston', 'TX', '38394', '333-333-3333', 'Libertybrewery@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of Liberty Brewery', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Tap Brewery', '35 Beach Street', 'Orlando', 'FL', '49384', '444-444-4444', 'Tapbrewery@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of Tap Brewery', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Freedom Brewery', '2244 Independence Blvd', 'Kansas City','MO', '64030', '555-555-5555', 'Freedombrewery@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of Freedom Brewery', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Silver Mine Brewery', '10 Mine Lane', 'Red Lodge', 'MT', '59068', '666-666-6666', 'SilverBrewery@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of Silver Brewery', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Poor Mice Brewery', '4554 Sococo Street', 'Valley Forge', 'PA', '19460', '777-777-7777', 'Poormice@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History Of Poor Mice Brews', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Scarlet Brewery', '183 Labrador Lane', 'Hershey', 'PA', '17017', '888-888-8888', 'Scarletbrewery@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of Scarlet Brewery', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Good Dog Brewery', '22 Park Lane', 'Kemmerer', 'WY', '83101', '999-999-9999', 'Gooddog@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of Good Dog Brewery', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Linden Lane Brewery', '101 Linden Lane', 'Linden', 'MI', '48451', '123-555-5555', 'LindenBrewery@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of LL Brewery', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Best Beach Brewery', '99 Bay Side Avenue', 'Oceanside', ' CA', '92003','212-555-9999', 'Bestbeachbrew@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of Best Beach Brewery', 3, true);
INSERT INTO breweries (brewery_name, brewery_address, brewery_city, brewery_state, brewery_zip, brewery_phone, brewery_email, brewery_hours,  brewery_history, brewer_id, active) VALUES ('Cat Scratch Brewery', '66 Swish Tails Court', 'Cat Spring', 'TX','78933', '323-555-3333', 'Catspringbrewery@email.com', '12,8,12,8,12,8,12,8,12,8,12,8', 'History of Cat Scratch Brewery', 3, true);
